...
const Experience = () => {
    ...
    return (
        ...
        <div id="about" className="h-fit py-4 bg-[#292D99] font-oxygen ">
            ...
            <div className='grid grid-col-1 md:grid-cols-2  lg:grid-cols-4 gap-2 justify-items-center h-fit py-10 bg-[#292D99]'>
                ...
                <div className='grid grid-cols-1 gap-3'>
                    ...
                    <p className="text-gray-200 text-base text-center mb-10 font-mono">Node JS</p>
                </div>
                <div className='grid grid-cols-1 gap-3'>
